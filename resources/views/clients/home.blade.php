    ...
    <div id="demo" class="carousel slide overflow-hidden" data-bs-ride="carousel" style="height: 480px;">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="{{ asset('images/banner10.png') }}" alt="Los Angeles" class="d-block w-100 h-100">
            </div>
            <div class="carousel-item">
                <img style="height: 100%;" src="{{ asset('images/banner8.png') }}" alt="Chicago"
                    class="d-block w-100 h-100">
            </div>
            <div class="carousel-item">
                <img src="{{ asset('images/banner11.png') }}" alt="New York" class="d-block w-100 h-100">
            </div>
        </div>
